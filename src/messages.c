...
const struct translation messages = {
    .trace = {.because_of = "because of",
              .which_is = "which is",
              .message_dropped = "message dropped"},
    .timestamp = {.overflow = "A version string exceeds the size limit"},
    .parents = {.cannot_remove_ancestor = "Cannot remove an ancestor directory",
                .cannot_create_ancestor =
                    "Cannot create an ancestor directory"},
    .sync = {.source_is_not_regular_file =
    ...
    .params = {.unknown_option = "An unknown option has been passed",
               ...
               .redefined_option =
                   "An option has been passed more than once, but "
                   "it cannot have multiple values"},
    .handler = {.version = {.has_slashes =
                                "Slash characters found in a version string"},
                .config = {.cannot_load = "Cannot load the configuration file",
                           .cannot_reload =
                               "Cannot reload the configuration file"},
                .linq = {.cannot_load = "Cannot load the debouncing link queue",
                         .cannot_reload =
                             "Cannot reload the debouncing link queue",
                         .cannot_get_head =
                             "Cannot get the head of the debouncing link queue",
                         .cannot_push =
                             "Cannot push a file to the debouncing link queue"},
                .store = {.cannot_copy = "Cannot copy a file to the store"},
    ...
    .main = {
        ...
        .mount = {.cannot_list = "Cannot list mount points",
